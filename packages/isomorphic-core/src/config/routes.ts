export const routes = {
  eCommerce: {
    ...
    createProductCategory: "/ecommerce/product-categories/create",
    productCategoryDetails: (id: string) => `/ecommerce/product-categories/${id}`,
    editProductCategory: (id: string) => `/ecommerce/product-categories/${id}/edit`,
