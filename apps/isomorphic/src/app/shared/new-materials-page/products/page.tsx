...
import { deleteMaterial, fetchMaterials, MaterialType } from '@/kedaimaster-api-handlers/materialApiHandlers';
    ...
    <>
      <PageHeader title={pageHeader.title} breadcrumb={pageHeader.breadcrumb}>
        <div className="mt-4 flex items-center gap-3 @lg:mt-0">
          ...
          />
          <Link to={routes.dashboard.createMaterial} className="w-full @lg:w-auto"> {/* Assuming new route for materials */}
